...
export default function Home() {
  return (
    <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column", fontFamily: "Inter, sans-serif" }}>
      {/* Navigation */}
      <nav style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 50, background: "rgba(247,249,251,0.8)", backdropFilter: "blur(12px)", borderBottom: "1px solid rgba(229,231,235,0.3)", padding: "0 24px" }}>
        <div style={{ maxWidth: 1440, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", height: 64 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            ...
            <span style={{ fontSize: 24, fontWeight: 600, color: "#0A2540", letterSpacing: "-0.01em" }}>VisitFlow</span>
          </div>
          <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
            <Link href="/appointment-status" style={{ fontSize: 12, fontWeight: 500, color: "#43474D", textDecoration: "none" }}>Check Status</Link>
            <Link href="/ai-assistant" style={{ fontSize: 12, fontWeight: 500, color: "#43474D", textDecoration: "none" }}>AI Assistant</Link>
            <Link href="/login" style={{ fontSize: 12, fontWeight: 600, color: "#0A2540", textDecoration: "none", padding: "6px 16px" }}>Login</Link>
            <Link href="/book-appointment" style={{ fontSize: 12, fontWeight: 700, color: "#fff", textDecoration: "none", padding: "8px 20px", background: "#0A2540", borderRadius: 10 }}>Book Demo</Link>
          </div>
        </div>
      </nav>
      ...
      <section style={{ paddingTop: 64, background: "radial-gradient(circle at top right, #006C4B 0%, #0A2540 60%)", position: "relative", overflow: "hidden" }}>
        <div style={{ maxWidth: 1440, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 32, padding: "80px 24px", alignItems: "center" }}>
          <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
            ...
            <h1 style={{ fontSize: 48, fontWeight: 700, color: "#fff", lineHeight: 1.15, letterSpacing: "-0.02em", margin: 0, maxWidth: 520 }}>
              Smart Appointments.{" "}
              <br />
            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: 16, paddingTop: 8 }}>
              <Link href="/book-appointment" style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "14px 32px", background: "#00C48C", color: "#fff", borderRadius: 10, fontWeight: 700, fontSize: 16, textDecoration: "none", boxShadow: "0 8px 24px rgba(0,196,140,0.3)" }}>
                Book Appointment <ArrowRightOutlined />
              </Link>
              <Link href="/appointment-status" style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "14px 32px", background: "rgba(255,255,255,0.05)", backdropFilter: "blur(12px)", border: "1px solid rgba(255,255,255,0.1)", color: "#fff", borderRadius: 10, fontWeight: 700, fontSize: 16, textDecoration: "none" }}>
                Track Appointment
              </Link>
            </div>
      ...
      {/* Trust Bar */}
      <section style={{ padding: "32px 24px", background: "#F2F4F6" }}>
        <div style={{ maxWidth: 1440, margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", justifyContent: "center", alignItems: "center", gap: 48, opacity: 0.7 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 8, fontWeight: 700, fontSize: 14, color: "#0A2540" }}><SafetyCertificateOutlined /> SOC2 TYPE II</div>
            <div style={{ display: "flex", alignItems: "center", gap: 8, fontWeight: 700, fontSize: 14, color: "#0A2540" }}><LockOutlined /> GDPR READY</div>
            <div style={{ display: "flex", alignItems: "center", gap: 8, fontWeight: 700, fontSize: 14, color: "#0A2540" }}><SafetyCertificateOutlined /> ISO 27001</div>
            <div style={{ display: "flex", alignItems: "center", gap: 8, fontWeight: 700, fontSize: 14, color: "#0A2540" }}><CheckCircleOutlined /> HIPAA COMPLIANT</div>
          </div>
        </div>
      </section>
      ...
      <section style={{ padding: "96px 24px", background: "#fff" }}>
        <div style={{ maxWidth: 1440, margin: "0 auto" }}>
          <div style={{ textAlign: "center", maxWidth: 640, margin: "0 auto 64px" }}>
            <h2 style={{ fontSize: 32, fontWeight: 700, color: "#0A2540", margin: 0, letterSpacing: "-0.01em" }}>Engineered for Operational Velocity</h2>
            <p style={{ fontSize: 16, color: "#43474D", marginTop: 12, lineHeight: 1.6 }}>Eliminate the friction of traditional visitor logs with a system that prioritizes security without compromising on the guest experience.</p>
          </div>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: 24 }}>
            {/* Feature 1 */}
            <div style={{ background: "#fff", border: "1px solid #E5E7EB", borderRadius: 20, padding: 32, display: "flex", flexDirection: "column", gap: 16 }}>
              ...
              <h3 style={{ fontSize: 24, fontWeight: 600, color: "#0A2540", margin: 0 }}>Instant QR Check-ins</h3>
            ...
            {/* Feature 2 */}
            <div style={{ background: "#0A2540", border: "1px solid rgba(255,255,255,0.1)", borderRadius: 20, padding: 32, display: "flex", flexDirection: "column", gap: 16 }}>
              ...
              <h3 style={{ fontSize: 24, fontWeight: 600, color: "#fff", margin: 0 }}>Enterprise Security</h3>
            ...
            <div style={{ background: "#fff", border: "1px solid #E5E7EB", borderRadius: 20, padding: 32, display: "flex", flexDirection: "column", gap: 16 }}>
              ...
              <h3 style={{ fontSize: 24, fontWeight: 600, color: "#0A2540", margin: 0 }}>Smart Scheduling</h3>
      ...
      <section style={{ padding: "80px 24px", background: "#F8FAFC" }}>
        <div style={{ maxWidth: 900, margin: "0 auto", textAlign: "center" }}>
          <h2 style={{ fontSize: 32, fontWeight: 700, color: "#0A2540", margin: "0 0 48px", letterSpacing: "-0.01em" }}>How It Works</h2>
